...
export const levels: Record<string, LevelConfig> = {
  level01: {
    id: 'level-01', title: 'Bleibe', expectedDurationMs: 66_000, storyDurationMs: 82_000,
    maximumDurationMs: 98_000, hintTimesMs: [22_000, 46_000, 72_000], echoId: 'echo-01', nextState: 'Echo01',
  },
  level02: {
  ...
  level03: {
    id: 'level-03', title: 'Versorge', expectedDurationMs: 72_000, storyDurationMs: 96_000,
    maximumDurationMs: 118_000, hintTimesMs: [26_000, 54_000, 86_000], echoId: 'echo-03', nextState: 'Echo03',
  },
  level04: {
